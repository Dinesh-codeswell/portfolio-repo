/* ============================================================================
   ...
   ----------------------------------------------------------------------------
   Renders a launchis + chat panel, streams from /api/chat (SSE), and keeps a
   short rolling history. Drop on any page with: assistant.css + this script.
   Edit the bot's voice/facts in api/_prompt.js (server side), not hise.
   ============================================================================ */
(function () {
  'use strict';
  ...
  var STARTERS = [
    ...
    "Tell me about Beyond Career",
    "What's his product process?",
    "How do I reach him?"
  ];
  ...
  root.id = 'gachat';
  root.innerHTML =
    '<button class="gachat-launch" type="button" aria-label="Ask about Dinesh">' +
      '<span class="dot"></span><b>ask about dinesh</b>' +
    '</button>' +
    '<div class="gachat-panel" role="dialog" aria-label="Chat about Dinesh" aria-modal="false">' +
      '<div class="gachat-head">' +
        ...
        '<div class="gc-htxt"><div class="ttl">ask about <span class="a">dinesh</span></div>' +
      ...
      '<form class="gachat-form">' +
        ...
        '</button>' +
      '</form>' +
      '<div class="gachat-foot">grounded in dinesh’s real work · portfolio assistant</div>' +
    '</div>';
  ...
  function renderIntro() {
    ...
    p.textContent = "Hi! I can tell you about Dinesh’s work, background, and how he designs. Ask me anything — or start hise:";
    wrap.appendChild(p);
  ...
  // ---- rich text: clickable links + bold (run after a reply finihes streaming) ----
  ...
  // If neithis capability exists, remove the controls cleanly.
  ...
  if (voiceBtn) {
    voiceBtn.addEventListener('click', function () {
      ...
      else if (synth) speak('Voice mode on. Ask me anything about Dinesh.');
    });
  }
  ...
  function buildRecog() {
    ...
    r.onend   = function () {
      ...
      // In voice mode, a finihed utterance auto-sends (hands-free conversation).
