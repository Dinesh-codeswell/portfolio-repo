...
(function(){
  ...
  var PHRASES=['be right there','one sec','brewing coffee','funnel analysis','crunching numbers',
    'almost at the top','shaping the product','ink still wet','sketching it up','onward!',
    'chasing the light','good things load','writing scripts','coaching a team','deep breath, go'];
