...
(function () {
  ...
  n.innerHTML =
    ...
    '<nav class="gnav-dock" aria-label="primary">' +
      ...
      '<a class="cta cta-ghost" href="mailto:dineshkatal.work@gmail.com">let&rsquo;s talk <span class="arw">&rarr;</span></a>' +
    '</nav>' +
