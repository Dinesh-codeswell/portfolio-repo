...
{/* ================= HERO ================= */}
{/* ============ ONE LC'S JOURNEY · cinematic cold open (scoped stj-) ============ */}
<section style={{ paddingBlock: "0", borderTop: "none" }}>


<div className="stj" id="stj">
  <div className="stick">
    <div className="stage">

      <div className="beat on" data-b="0">
        <div className="stepk">the trade</div>
        <div className="steph">Goods ready to ship. Payment guaranteed by a document.</div>
        <div className="big">One letter of credit, <span className="a">still on paper.</span></div>
      </div>

      <div className="beat" data-b="1">
        <div className="stepk">the old way</div>
        <div className="steph">Before anything could move, the paper had to.</div>
        <div className="pile" id="stjpile">
          <div className="pg"><span className="ic">🖨️</span><span>Print the dossier, <b>every page of it</b></span></div>
          <div className="pg"><span className="ic">🖋️</span><span>Sign in <b>wet ink</b></span></div>
          <div className="pg"><span className="ic">🚚</span><span>Courier it <b>to the branch</b></span></div>
          <div className="pg"><span className="ic">😕</span><span>Then wait, with <b>no view of where it stands</b></span></div>
          <div className="still" id="stjstill">days in transit · status unknown</div>
        </div>
      </div>

      <div className="beat" data-b="2">
        <div className="stepk">smarttrade</div>
        <div className="steph">The same letter of credit, raised in one sitting.</div>
        <div className="lc">
          <div className="ttl"><span>Initiate Letter of Credit</span><span>UCP 600</span></div>
          <div className="fr"><span className="k">Applicant</span><span className="v">Al Noor Trading LLC</span></div>
          <div className="fr"><span className="k">Beneficiary</span><span className="v">Shanghai Exports Co.</span></div>
          <div className="fr"><span className="k">Amount</span><span className="v">USD 1,200,000</span></div>
          <div className="fr"><span className="k">Expiry</span><span className="v">90 days</span></div>
          <div className="sub" id="stjsub">✓ Submitted · maker-checker · tracked in real time</div>
        </div>
      </div>

      <div className="beat" data-b="3">
        <div className="stepk">shipped · emirates nbd</div>
        <div className="num"><span id="stjnum">1.0</span><span className="a">×</span></div>
        <div className="cap">trade requests after the redesign. Fully paperless for government clients.</div>
      </div>
...
<Script id="script-case-smarttrade-0" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: `(function(){
  var RM=window.matchMedia('(prefers-reduced-motion: reduce)').matches;
  var host=document.getElementById('stj'); if(!host||RM) return;
  var beats=[].slice.call(host.querySelectorAll('.beat'));
  var pgs=[].slice.call(host.querySelectorAll('.pg'));
  var still=document.getElementById('stjstill');
  var frs=[].slice.call(host.querySelectorAll('.lc .fr'));
  var sub=document.getElementById('stjsub');
  var num=document.getElementById('stjnum');
  var N=4;
  function render(p){
    ...
    if(idx===2){
      frs.forEach(function(fr,k){ fr.classList.toggle('on', t>0.08+k*0.14); });
      sub.classList.toggle('on', t>0.72);
    }
    if(idx===3){
      var e=1-Math.pow(1-Math.min(1,t*1.5),3);
      num.textContent=(1+1.5*e).toFixed(1);
    }
  }
  var ticking=false;
  function onScroll(){
  ...
  <div className="wrap">
    <div className="hero-grid">
      <div className="hero-txt">
        <div className="kicker-row" style={{ translate: "none", rotate: "none", scale: "none", transform: "translate3d(0px, 0.0268px, 0px)", opacity: "0.999", visibility: "inherit" }}>
          <span className="eyebrow">smartTRADE · fintech · trade finance · corporate b2b</span>
        </div>

        <h1 data-split="1"><span className="wr">trade</span> <span className="wr">finance,</span> <span className="wr">out</span> <span className="wr">of</span> <span className="wr">the</span> <span className="accent"><span className="wr">paper</span> <span className="wr">age.</span></span></h1>

        <p className="lede reveal" style={{ translate: "none", rotate: "none", scale: "none", transform: "translate3d(0px, 0.0536px, 0px)", opacity: "0.9979", visibility: "inherit" }}>
          Corporate clients raised letters of credit through wet ink, couriers and opaque handoffs, with no way to see where anything stood. I owned the <b>2024 redesign</b> of <b>smartTRADE</b>, Emirates NBD's online trade hub: letter-of-credit, guarantee, discrepancy, settlement and tracking, with <b>UCP&nbsp;600</b> and <b>maker-checker</b> controls intact.
        </p>
      </div>

      <div className="hero-stage" aria-hidden="true" style={{ translate: "none", rotate: "none", scale: "none", transform: "translate3d(0px, 0.1072px, 0px)", opacity: "0.9959", visibility: "inherit" }}>
        <div className="glow"></div>
        <figure className="bw bw-main"><div className="bw-bar"><i className="r"></i><i className="y"></i><i className="g"></i><span className="url"><span style={{ color: "var(--accent)" }}>●</span> live · smarttrade · initiate LC</span></div><div className="shot"><video src="../assets/case/smarttrade/cover-loop.mp4" poster="../assets/case/smarttrade/cover-loop-poster.jpg" muted loop playsInline autoPlay></video></div></figure>
      </div>
    </div>

    {/* 3-number metric hero */}
    <div className="metrics reveal" style={{ translate: "none", rotate: "none", scale: "none", transform: "translate3d(0px, 0.2144px, 0px)", opacity: "0.9918", visibility: "inherit" }}>
      <div className="metric">
        <div className="big"><span>AED 1bn</span></div>
        <div className="label">Emirates NBD's investment in digitising its corporate bank, the programme my redesign sat inside.</div>
        <span className="eyebrow tag">The mandate</span>
      </div>
      <div className="metric">
        <div className="big"><span>~25%</span></div>
        <div className="label">Of the UAE letters-of-credit market runs on this platform, the scale my flows had to hold.</div>
        <span className="eyebrow tag">The stakes</span>
      </div>
      <div className="metric">
        <div className="big"><span>9 tabs → 1</span></div>
        <div className="label">The most field-heavy instrument in banking, collapsed into one scannable review before anything commits.</div>
        <span className="eyebrow tag">The redesign</span>
      </div>
    </div>
    <p className="note" style={{ marginTop: "16px", textAlign: "center", translate: "none", rotate: "none", scale: "none", transform: "translate3d(0px, 0.4288px, 0px)", opacity: "0.9835", visibility: "inherit" }}>platform context reported by Emirates NBD, public sources · redesign shipped 2024</p>
  </div>
</header>
    ...
    <div className="snap-card cn-tilt" data-cine-tilt="1" style={{ translate: "none", rotate: "none", scale: "none", transform: "perspective(1100px)" }}>
      <div className="snap-facts">
        <div className="snap-fact">
          ...
          <p>Sr. Product Designer · smartTRADE, Emirates NBD</p>
        </div>
        <div className="snap-fact">
          <span className="eyebrow">Team</span>
          <p>Cross-functional squad: product, trade ops, engineering, design</p>
        </div>
        <div className="snap-fact">
      ...
      <div className="snapshot">
        <div className="snap-cell">
          ...
          <p>Owned smartTRADE's trade-finance journeys, and held one line: drop the paper, keep the controls. Led the research, journey design, document upload, approval flows, review-before-commit and the live tracking dashboard.</p>
        </div>
        <div className="snap-cell">
          <span className="eyebrow">Impact</span>
          <p>Redesigned the import-LC, discrepancy and settlement journeys on the platform carrying ~25% of the UAE's letters of credit: one tabbed canvas, a single review-before-commit, maker-checker governance fully intact.</p>
        </div>
        <div className="snap-cell">
          <span className="eyebrow">Constraints</span>
          <p>Regulated trade instruments (UCP&nbsp;600 / ICC rules), maker-checker governance, document-heavy workflows and many products inside one hub.</p>
        </div>
      </div>
    </div>
  </div>
...
<section id="sec-0">
  <div className="wrap">
    <div className="sec-head reveal">
      ...
      <h2 data-split="1"><span className="wr">a</span> <span className="wr">billion-dirham</span> <span className="wr">bet</span> <span className="wr">on</span> <span className="accent"><span className="wr">digital.</span></span></h2>
    </div>
    <div className="body-col reveal">
      <p>Emirates NBD put <b>AED&nbsp;1 billion</b> into digitising its corporate bank. Trade finance was the most paper-bound part of that estate, and among the most valuable: the bank holds roughly a <b>quarter of the UAE market</b> in letters of credit.</p>
    </div>
    <div className="cards trio reveal" style={{ marginTop: "26px" }}>
      <div className="card">
        <span className="num">what I inherited</span>
        <h3>a bet already proven</h3>
        <p>Trade requests up <b>2.5×</b> (2019→2021), guarantee processing <b>80% faster</b>, fully paperless for government clients.</p>
      </div>
      <div className="card">
        <span className="num">my brief · 2024</span>
        <h3>the harder second act</h3>
        <p>Journeys that had won on <b>availability</b>, redesigned to win on <b>usability</b>: the LC wizard, discrepancies, settlement.</p>
      </div>
      <div className="card">
        <span className="num">the line I held</span>
        <h3>drop the paper, keep the controls</h3>
        <p>Maker-checker and every regulated control stayed fully intact. Only the wet ink and couriers left.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="sec-1">
  <div className="wrap">
    <div className="sec-head reveal">
      ...
      <h2 data-split="1"><span className="wr">a</span> <span className="wr">branch</span> <span className="wr">visit</span> <span className="wr">for</span> <span className="accent"><span className="wr">everything.</span></span></h2>
    </div>
    <div className="cards reveal">
      <div className="card">
        <div className="num">01</div>
        <h3>Paper, couriered to a counter</h3>
        <p>Every LC, guarantee or trade-loan request meant a physical dossier, signed in wet ink and carried to a branch before anything could move.</p>
      </div>
      <div className="card">
        <div className="num">02</div>
        <h3>Submitted, then blind</h3>
        <p>Once a request was in, the client had no way to see where it stood. Status meant phoning the relationship manager or chasing trade ops.</p>
      </div>
      <div className="card">
        <div className="num">03</div>
        <h3>Re-keyed, and error-prone</h3>
        <p>The same terms were typed and re-typed across forms by hand. Manual handling bred redundancy, rejections and rework on tiny discrepancies.</p>
      </div>
      <div className="card">
        <div className="num">04</div>
        <h3>Many products, no single home</h3>
        <p>LCs, guarantees, collections and loans each lived in their own process. A treasury team had no one place to run their trade portfolio.</p>
      </div>
    </div>

    <div className="pullquote reveal">
      <span className="qmark">“</span>
      <div className="qlabel">the signal · stakeholder &amp; client research</div>
      <div className="qbig">where is my LC right now?</div>
      <div className="qsrc"><span>Importers</span><span>Exporters</span><span>Corporate trade ops</span></div>
      <div className="qfoot">Visibility, not new features, was what clients asked for first.</div>
    </div>
  </div>
</section>

{/* ================= THE OLD WAY VS smartTRADE ================= */}
<section id="sec-2">
  <div className="wrap">
    <div className="sec-head reveal">
      <span className="eyebrow">03 · The shift</span>
      <h2 data-split="1"><span className="wr">from</span> <span className="wr">the</span> <span className="wr">counter</span> <span className="wr">to</span> <span className="wr">the</span> <span className="accent"><span className="wr">desk.</span></span></h2>
    </div>
    <div className="body-col reveal" style={{ marginBottom: "30px" }}>
      <p>Raising an import LC, the core task. Before and after smartTRADE.</p>
    </div>
    <div className="body-col reveal" style={{ marginBottom: "30px" }}>
      <p><b>The bet behind it.</b> The fastest way to speed up paper is to thin maker-checker approvals. But in trade finance the controls <i>are</i> the product. So the rigor stayed, intact and digital, and the speed came from elsewhere: saved clause templates, digital upload, live status. Trust survived the move online; only the paper didn't.</p>
    </div>
    <div className="shiftblk">
      <div><span className="old">a slow, opaque paper trail</span><span className="arw">→</span></div>
      <span className="new">every trade product, <em>online and visible</em>.</span>
      <p className="ssub">Days of paperwork with no status, now LCs, guarantees, collections and loans run online, in one place, with status you can track.</p>
    </div>
  </div>
</section>
...
<section id="sec-3">
  <div className="wrap">
    <div className="sec-head reveal">
      ...
      <h2 data-split="1"><span className="wr">designed</span> <span className="wr">for</span> <span className="accent"><span className="wr">trust.</span></span></h2>
    </div>
    <div className="body-col reveal">
      <p>Learn the real trade-ops anxieties, prototype a flow that keeps the bank's controls but loses the paper, and validate it sprint by sprint with engineering.</p>
    </div>
    ...
    <div className="words reveal">
      <div className="wcard cn-tilt" data-cine-tilt="1" style={{ translate: "none", rotate: "none", scale: "none", transform: "perspective(1100px)" }}>
        <blockquote className="wq">“I just need to know my guarantee was received and is moving, not find out three days later it bounced.”</blockquote>
        <div className="wpersona"><img className="wav" src="https://api.dicebear.com/9.x/notionists/svg?seed=Rajesh&amp;backgroundColor=c0e6ff,b6e3f4" alt="" /><div><span className="wname">Rajesh P.</span><span className="wctx">Corporate Treasury</span></div></div>
      </div>
      <div className="wcard cn-tilt" data-cine-tilt="1" style={{ translate: "none", rotate: "none", scale: "none", transform: "perspective(1100px)" }}>
        <blockquote className="wq">“Our LCs all share the same clauses. Typing them fresh every time is where the mistakes creep in.”</blockquote>
        <div className="wpersona"><img className="wav" src="https://api.dicebear.com/9.x/notionists/svg?seed=Fatima&amp;backgroundColor=ffd5dc,ffdfbf" alt="" /><div><span className="wname">Fatima Z.</span><span className="wctx">Trade Operations</span></div></div>
      </div>
      <div className="wcard cn-tilt" data-cine-tilt="1" style={{ translate: "none", rotate: "none", scale: "none", transform: "perspective(1100px)" }}>
        <blockquote className="wq">“Nothing leaves our company without a second pair of eyes. The tool has to respect that.”</blockquote>
        <div className="wpersona"><img className="wav" src="https://api.dicebear.com/9.x/notionists/svg?seed=Daniel&amp;backgroundColor=d1d4f9,c0aede" alt="" /><div><span className="wname">Daniel O.</span><span className="wctx">Finance Controller · Checker</span></div></div>
      </div>
    </div>
    ...
    <div className="reframe">
      ...
      <p className="re-line">A separate tool per product ships faster, but it rebuilds the old silos and makes users relearn the bank product by product. Instead: <strong>one hub, one pattern</strong>, the whole portfolio in one place.</p>
    </div>
    ...
    <div className="stepper" id="stepper">
      ...
      <div className="step-panels">
        <div className="step-panel active" data-panel="0">
          <h3>reframe paper as a flow</h3>
          <p>A service blueprint of the journey showed the blocker wasn't the form. It was the missing <b>visibility and second-eyes governance</b> once paper left the building.</p>
        </div>
        <div className="step-panel" data-panel="1">
          <h3>prototype the online request</h3>
          <p>LC and guarantee flows with reusable clause templates, digital upload and a maker-checker route built in, not bolted on.</p>
        </div>
        <div className="step-panel" data-panel="2">
          <h3>validate with real users</h3>
          <p>Usability-tested the online flow against the paper process. Far faster, with far more confidence a request was moving.</p>
        </div>
        <div className="step-panel" data-panel="3">
          <h3>ship a responsive system</h3>
          <p>Delivered a responsive design system so the same trade patterns held across products and devices, and new instruments could be added without redrawing the hub.</p>
        </div>
      </div>
    </div>
  </div>
...
<section id="sec-4">
  <div className="wrap">
    <div className="sec-head reveal">
      ...
      <h2 data-split="1"><span className="wr">the</span> <span className="wr">trade</span> <span className="wr">hub,</span> <span className="wr">made</span> <span className="accent"><span className="wr">legible.</span></span></h2>
    </div>
    <div className="body-col reveal" style={{ marginBottom: "34px" }}>
      <p>An import LC is one of the most field-heavy instruments in banking. I designed it as a <b>nine-step tabbed canvas</b> that ends in one scannable <b>review</b> before anything is committed.</p>
    </div>

    {/* hero shot: the Review screen (most complete single view) */}
    <figure className="shotfig">
      <div className="screenframe"><div className="sf-bar"><i></i><i></i><i></i><span className="sf-url">smarttrade · initiate review</span></div><div className="sf-scroll" data-lenis-prevent=""><img className="shot" src="../assets/case/smarttrade/initiate-review.png" alt="smartTRADE, import LC review screen, the whole application summarised before submit" onError={(e) => { const target = e.currentTarget.closest('.shotfig')?.querySelector('.screenframe') as any; if (target) target.style.display = 'none'; }} /></div></div>
      <figcaption className="shot-cap">Initiate LC › Review: every tab in one final, editable summary</figcaption>
    </figure>

    <div className="shot-grid" style={{ marginTop: "26px" }}>
      <figure className="shotfig">
        <div className="screenframe"><div className="sf-bar"><i></i><i></i><i></i><span className="sf-url">smarttrade · initiate lc details</span></div><div className="sf-scroll" data-lenis-prevent=""><img className="shot" src="../assets/case/smarttrade/initiate-lc-details.png" alt="smartTRADE, LC details entry, first step of the import LC wizard" onError={(e) => { const target = e.currentTarget.closest('.shotfig')?.querySelector('.screenframe') as any; if (target) target.style.display = 'none'; }} /></div></div>
        <figcaption className="shot-cap">step one · LC details, applicant &amp; beneficiary</figcaption>
      </figure>
      <figure className="shotfig">
        <div className="screenframe"><div className="sf-bar"><i></i><i></i><i></i><span className="sf-url">smarttrade · initiate documents</span></div><div className="sf-scroll" data-lenis-prevent=""><img className="shot" src="../assets/case/smarttrade/initiate-documents.png" alt="smartTRADE, documents and conditions step of the import LC wizard" onError={(e) => { const target = e.currentTarget.closest('.shotfig')?.querySelector('.screenframe') as any; if (target) target.style.display = 'none'; }} /></div></div>
        <figcaption className="shot-cap">required documents &amp; additional conditions</figcaption>
      </figure>
    </div>
  </div>
</section>

{/* ================= THE FLOW (stepper-driven, no external assets) ================= */}
<section id="sec-5">
  <div className="wrap">
    <div className="sec-head reveal">
      <span className="eyebrow">06 · The flow</span>
      <h2 data-split="1"><span className="wr">raising</span> <span className="wr">an</span> <span className="wr">LC,</span> <span className="wr">step</span> <span className="wr">by</span> <span className="accent"><span className="wr">step.</span></span></h2>
    </div>
    <div className="body-col reveal" style={{ marginBottom: "18px" }}>
      <p>The core journey, the way a user moves through it: fill the tabs in any order, attach what's needed, review before committing. <span className="note">scroll, the screen follows each step ↓</span></p>
    </div>

    {/* scrollytelling: sticky screen crossfades as the captions scroll (see case-st-ix.*) */}
    <div className="st-scrolly">
      <div className="st-stickywrap">
        <div className="st-sticky">
          <div className="sf-bar"><i></i><i></i><i></i><span className="sf-url">smarttrade · initiate import lc</span></div>
          <div className="st-stage" id="stStage">
            <img data-i="0" className="on" src="../assets/case/smarttrade/initiate-lc-details.png" alt="LC details step" />
            <img data-i="1" src="../assets/case/smarttrade/initiate-documents.png" alt="documents and conditions step" />
            <img data-i="2" src="../assets/case/smarttrade/initiate-attachments.png" alt="attachments step" />
            <img data-i="3" src="../assets/case/smarttrade/initiate-review.png" alt="review and submit step" />
          </div>
        </div>
      </div>
      <div className="st-steps" id="stSteps">
        <div className="st-step act" data-i="0">
          <div className="n">01</div>
          <h3>start with the LC details</h3>
          <p>Applicant, beneficiary, amount and credit terms. The tabbed canvas lets users jump between sections instead of one endless form.</p>
        </div>
        <div className="st-step" data-i="1">
          <div className="n">02</div>
          <h3>set documents &amp; conditions</h3>
          <p>Select the documents the LC requires and add conditions, the terms once hand-typed onto paper, now structured and reusable.</p>
        </div>
        <div className="st-step" data-i="2">
          <div className="n">03</div>
          <h3>attach the paperwork, digitally</h3>
          <p>Invoices, proformas and supporting files upload right in the flow. The courier and the counter, replaced by drag-and-drop.</p>
        </div>
        <div className="st-step" data-i="3">
          <div className="n">04</div>
          <h3>review, then submit for approval</h3>
          <p>Every tab collapses into one scannable summary, with an inline error state if something's missing, before routing through maker-checker.</p>
        </div>
      </div>
    </div>
    ...
    <div style={{ marginTop: "52px", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: "22px", alignItems: "start" }}>
      <div>
        <figure className="bw"><video src="../assets/case/smarttrade/status.mp4" muted loop playsInline autoPlay></video></figure>
        <p className="note" style={{ marginTop: "14px", textAlign: "center" }}>the client watches the request move through maker-checker in real time, answering “where is my lc right now?” on screen.</p>
      </div>
      <div>
        <figure className="bw"><video src="../assets/case/smarttrade/tabs.mp4" muted loop playsInline autoPlay></video></figure>
        <p className="note" style={{ marginTop: "14px", textAlign: "center" }}>nine field-heavy sections validate and collapse into one scannable review before anything commits.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="sec-6">
  <div className="wrap">
    <div className="sec-head reveal">
      ...
      <h2 data-split="1"><span className="wr">controls</span> <span className="wr">kept,</span> <span className="accent"><span className="wr">paper</span> <span className="wr">dropped.</span></span></h2>
    </div>
    <div className="body-col reveal" style={{ marginBottom: "30px" }}>
      <p>The hard part of digitising a regulated instrument is keeping its governance intact while shedding its paper. Four decisions carried that weight.</p>
    </div>
    <div className="cards reveal">
      <div className="card">
        <div className="num">01</div>
        <h3>Discrepancies, handled in-flow</h3>
        <p>When a discrepant bill arrives, the user sees settlement, forex and charges together and <b>accepts or rejects on one screen</b>. The moment that once meant a phone call and days of limbo.</p>
      </div>
      <div className="card">
        <div className="num">02</div>
        <h3>Three ways to settle</h3>
        <p>At settlement the user picks how to fund it (<b>Trust Receipt, account debit, or account + loan</b>) and links forex deals inside the flow. Financing is a choice, not a separate trip to the bank.</p>
      </div>
      <div className="card">
        <div className="num">03</div>
        <h3>One structure, every action</h3>
        <p>Create, amend, view and settle all share one tabbed anatomy. The Figma file's own note: <em>"all the other tabs follow the same structure as LC creation."</em> Learn it once, use it everywhere.</p>
      </div>
      <div className="card">
        <div className="num">04</div>
        <h3>Review before you commit</h3>
        <p>The Review step has expanded, collapsed and <b>error</b> states, so nothing submits half-finished, then routes through maker-checker for a real second pair of eyes.</p>
      </div>
    </div>

    <p className="voices-label" style={{ margin: "34px 0 14px" }}>the discrepancy screen, annotated · hover or tap the pins</p>
    {/* hotspot annotations (see case-st-ix.*) */}
    <div className="ix-hs">
      <img src="../assets/case/smarttrade/discrepancy.png" alt="smartTRADE bill discrepancy acceptance, annotated" />
      <div className="ix-pin down" style={{ left: "12.5%", top: "24%" }}>1<span className="tip">Five tabs, discrepancy, settlement, forex, charges, attachments, resolved in one flow, not five errands.</span></div>
      <div className="ix-pin" style={{ left: "50%", top: "40%" }}>2<span className="tip">Every accept or reject is captured with mandatory remarks, an auditable decision, not a phone call.</span></div>
      <div className="ix-pin" style={{ left: "35%", top: "73.5%" }}>3<span className="tip">Decide line by line, or accept and reject the whole bill at once.</span></div>
    </div>
    <figcaption className="shot-cap" style={{ marginTop: "12px" }}>discrepancy acceptance, review, settle and decide in one place</figcaption>

    {/* motion: discrepancy decided in-flow */}
    <figure className="bw" style={{ margin: "44px auto 0", maxWidth: "560px" }}><video src="../assets/case/smarttrade/discrepancy.mp4" muted loop playsInline autoPlay></video></figure>
    <p className="note" style={{ maxWidth: "560px", margin: "14px auto 0", textAlign: "center" }}>a discrepant bill decided line by line: accept, or reject with mandatory remarks. <b>why capture remarks?</b> every decision becomes an auditable record, not a phone call and days of limbo.</p>
  </div>
</section>
...
<section id="sec-7">
  <div className="wrap">
    ...
    <div className="body-col reveal" style={{ marginBottom: "24px" }}>
      <p>The four flows that carry the module: initiate, view, accept a discrepancy, settle. <span className="note">click any screen to view it full size ⤢</span></p>
    </div>
    {/* click-to-zoom bento (see case-st-ix.*) */}
    <div className="st-bento">
      <div className="st-cell" data-zoom="../assets/case/smarttrade/view-lc.png" data-alt="View LC, full record">
        <div className="st-thumb"><img src="../assets/case/smarttrade/view-lc.png" alt="view LC overview with bills, SWIFT, advice and amendments" /></div>
        <span className="zoom">⤢</span>
        <div className="cap">view LC · bills, SWIFT, advice, amendments</div>
      </div>
      <div className="st-cell" data-zoom="../assets/case/smarttrade/initiate-review.png" data-alt="Initiate LC, Review">
        <div className="st-thumb"><img src="../assets/case/smarttrade/initiate-review.png" alt="initiate LC review" /></div>
        <span className="zoom">⤢</span>
        <div className="cap">initiate · the full application, reviewed before submit</div>
      </div>
      <div className="st-cell" data-zoom="../assets/case/smarttrade/discrepancy.png" data-alt="Bill discrepancy acceptance">
        <div className="st-thumb"><img src="../assets/case/smarttrade/discrepancy.png" alt="bill discrepancy acceptance" /></div>
        <span className="zoom">⤢</span>
        <div className="cap">discrepancy · decide without leaving the screen</div>
      </div>
      <div className="st-cell" data-zoom="../assets/case/smarttrade/settlement-financing.png" data-alt="Bill settlement financing">
        <div className="st-thumb"><img src="../assets/case/smarttrade/settlement-financing.png" alt="bill settlement financing" /></div>
        <span className="zoom">⤢</span>
        <div className="cap">settle · choose the financing, link the forex</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div className="wrap">
    ...
    <div className="impact reveal">
      <div className="imp user">
        <span className="eyebrow">For the client</span>
        <div className="ibig"><span>9 tabs → 1</span></div>
        <p>The most field-heavy instrument in banking, raised from one tabbed canvas with a single scannable review before anything commits.</p>
      </div>
      <div className="imp biz">
        <span className="eyebrow">For the business</span>
        <div className="ibig"><span>5 errands → 1 flow</span></div>
        <p>Discrepancy, settlement, forex, charges and attachments, decided on one screen instead of a phone call and days of limbo.</p>
      </div>
      <div className="imp org">
        <span className="eyebrow">For operations</span>
        <div className="ibig"><span>1 pattern</span></div>
        <p>Create, amend, view and settle share one tabbed anatomy. Every new instrument added to the hub inherits it, with maker-checker intact.</p>
      </div>
    </div>
    </div>
    <p className="note" style={{ textAlign: "center", marginTop: "18px" }}>redesign shipped 2024 · platform context (2.5× growth 2019→2021, 80% faster guarantees) reported by Emirates NBD, public sources</p>
  </div>
</section>
...
<section id="sec-9">
  <div className="wrap">
    <div className="sec-head reveal">
      <span className="eyebrow">10 · Recognition</span>
      <h2 data-split="1"><span className="wr">the</span> <span className="wr">work,</span> <span className="accent"><span className="wr">valued.</span></span></h2>
    </div>
    <div className="reco">
      <figure className="rphoto">
        <img className="rimg" src="../assets/case/smarttrade/award-event.jpg" alt="Dinesh Kumar Katal with the team at the smartTRADE launch event in Dubai" />
        <figcaption>the smartTRADE launch · Dubai</figcaption>
      </figure>
      <figure className="rphoto">
        <img className="rimg" src="../assets/case/smarttrade/award-souwti.jpg" alt="Souwti 'Your Voice Matters' appreciation certificate presented to Dinesh Kumar Katal" />
        <figcaption>Souwti · Your Voice Matters</figcaption>
      </figure>
      <div className="rtext">
        <span className="rbadge">Emirates NBD · Group IT</span>
        <h3>recognised for the smartTRADE work</h3>
        <p>The bank's Group Information Technology team gave me a <b>Souwti "Your Voice Matters"</b> appreciation award for my work on the platform.</p>
        <p className="rq">"In appreciation of your good work and extraordinary support to help us achieve our goals. We value what you have done and continue to do."</p>
      </div>
    </div>
    <p className="note" style={{ marginTop: "16px" }}>internal recognition · Emirates NBD Group Information Technology</p>
  </div>
</section>
...
<section id="sec-10">
  <div className="wrap">
    ...
    <div className="refl-split">
      <h2 className="rs-big">we brought the whole branch <em>online.</em></h2>
      <div className="rs-body">
        <p>This wasn't a tool per product. It was a re-alignment, one hub, one pattern, the whole trade portfolio in a single place instead of a stack of silos.</p>
        <p>The controls were never obstacles to design around. They were requirements that had to become understandable, predictable and hard to misuse, so a corporate could raise and track a deal from their own desk.</p>
        <p>Building it meant unlearning the old paper flow, blueprinting the journey, testing it sprint by sprint, and reworking until governance and convenience finally lived together.</p>
        <p>And the pattern keeps growing. New instruments, predictive status, discrepancies caught before they happen, the hub should keep expanding long after this release.</p>
      </div>
    </div>
  </div>
</section>
...
<section>
  <div className="wrap">
    <div className="quote reveal">
      <div className="q">Good trade-finance design isn't a prettier form. It's a treasury team raising a letter of credit from their desk and knowing, the whole way, exactly where it stands.</div>
      <div className="who">The principle behind the hub</div>
    </div>
  </div>
</section>
...
<section>
  <div className="wrap">
    <div className="handoff reveal">
      ...
      <h2>I shipped <span className="accent">visibility</span>, not just screens.</h2>
      <p>A responsive design system and a reusable trade-request pattern, handed to engineering so the same governance held across every instrument in the hub.</p>
      <p>Accessible by default: AA-contrast tokens, clear focus states, and legible numerals for amounts, references, and dates.</p>
    </div>
  </div>
</section>
...
<footer>
  <div className="wrap">
    ...
    <a className="nextcase reveal" href="/case-fxonline">
      <span className="t">fx online →</span>
    </a>
  </div>
</footer>
...
{/* interactions */}
<Script id="script-case-smarttrade-1" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: `(function(){
  ...
  /* ---- count-up on every metric number + reveal its arrow (supports decimals + ×) ---- */
  function countEl(el){
    ...
    setTimeout(function(){ requestAnimationFrame(function step(ts){ if(!t0)t0=ts; var p=Math.min(1,(ts-t0)/dur); var e=1-Math.pow(1-p,3);
      el.textContent=fmt(target*e)+(p>=1?suffix:''); if(p<1) requestAnimationFrame(step); else el.textContent=fmt(target)+suffix; }); }, delay);
  }
  var metricLoop=null;
...
})();` }} /><div id="secnav"><a href="#sec-0"><span className="lbl">Context</span></a><a href="#sec-1"><span className="lbl">Problem</span></a><a href="#sec-2"><span className="lbl">The shift</span></a><a href="#sec-3"><span className="lbl">Process</span></a><a href="#sec-4"><span className="lbl">Solution</span></a><a href="#sec-5"><span className="lbl">The flow</span></a><a href="#sec-6"><span className="lbl">Design decisions</span></a><a href="#sec-7"><span className="lbl">Screens</span></a><a href="#sec-8"><span className="lbl">Impact</span></a><a href="#sec-9"><span className="lbl">Recognition</span></a><a href="#sec-10"><span className="lbl">Reflection</span></a></div>
  {/* real-screen interactions: scrollytelling flow · hotspots · lightbox */}
  <link rel="stylesheet" href="../assets/case/case-st-ix.css" />
  <div id="stlb" aria-hidden="true"><span className="x">✕</span><img src="" alt="" /><div className="hint">click anywhere to close · esc</div></div>
  <Script src="/../assets/case/case-st-ix.js"  strategy="afterInteractive" />
...
<style dangerouslySetInnerHTML={{ __html: `:root{
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  /* product-forward hero: text + browser-window frames (tall pages cropped to top) */
  ...
  .hero-stage{position:relative;min-height:450px;display:flex;align-items:center;justify-content:center;}
  .hero-stage .glow{position:absolute;width:520px;height:440px;border-radius:50%;background:radial-gradient(circle,rgba(22,32,43,.15),transparent 65%);z-index:0;}
  ...
  .bw .shot{overflow:hidden;aspect-ratio:16/11}
  .bw .shot img,.bw .shot video{display:block;width:100%;height:100%;object-fit:cover;object-position:top}
  .bw-main{position:relative;z-index:3;width:106%;max-width:470px}
  .bw-back{position:absolute;z-index:2;width:58%;max-width:265px;top:-10%;right:-5%;transform:rotate(3.5deg);opacity:.92}
  .hp-tag{position:absolute;z-index:5;font-family:'Geist Mono',monospace;font-size:10px;letter-spacing:.06em;text-transform:uppercase;background:var(--surface);color:var(--ink);padding:7px 12px;border-radius:var(--r-pill);box-shadow:0 12px 30px -14px rgba(0,0,0,.4);border:1px solid var(--line)}
  .hp-tag.t1{bottom:7%;left:-3%} .hp-tag.t1 .d{color:var(--accent);font-weight:400}
  .hp-tag.t2{top:3%;left:12%}
  ...
  /* ---- real screen shots (graceful fallback to .visual placeholder if PNG missing) ---- */
  .shotfig{margin:0}
  .shot{width:100%;height:auto;display:block;border:1px solid var(--hairline);border-radius:var(--r-2);background:var(--surface-2);box-shadow:var(--shadow-1)}
  .shot-cap{font-family:'Geist Mono',monospace;text-transform:uppercase;letter-spacing:.09em;font-size:11px;color:var(--ink-faint);margin-top:12px}
  .shot-grid{display:grid;grid-template-columns:1fr 1fr;gap:var(--s-4)}
  /* alternating image+text steps */
  .shot-steps{display:flex;flex-direction:column;gap:var(--s-5);margin-top:var(--s-2)}
  .shot-step{display:grid;grid-template-columns:1.25fr 1fr;gap:34px;align-items:center}
  .shot-step:nth-child(even){grid-template-columns:1fr 1.25fr}
  .shot-step:nth-child(even) .shot-txt{order:-1}
  .shot-step .shot-txt .num{font-family:'Geist Mono',monospace;font-size:12px;color:var(--accent);letter-spacing:.1em}
  .shot-step .shot-txt h3{font-size:23px;margin:8px 0 8px}
  .shot-step .shot-txt p{font-size:15px;color:var(--ink-soft)}
  @media(max-width:820px){.shot-grid,.shot-step,.shot-step:nth-child(even){grid-template-columns:1fr}.shot-step:nth-child(even) .shot-txt{order:0}}

  /* ---- scrollable screen window (full app screens shown at viewport size, scroll to reveal) ---- */
  .screenframe{border:1px solid rgba(20,32,52,.12);border-radius:var(--r-2);overflow:hidden;background:var(--surface-2);box-shadow:var(--shadow-1)}
  .sf-bar{display:flex;align-items:center;gap:7px;padding:11px 15px;background:var(--surface-2);border-bottom:1px solid var(--line)}
  .sf-bar i{width:11px;height:11px;border-radius:50%;background:#d9d3c8;display:block;flex:0 0 auto}
  .sf-bar i:nth-child(1){background:#e09b78}
  .sf-bar i:nth-child(2){background:#e3c982}
  .sf-bar i:nth-child(3){background:#9ec79a}
  .sf-url{margin-left:9px;font-family:'Geist Mono',monospace;font-size:11px;color:var(--ink-faint);letter-spacing:.03em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  .sf-scroll{max-height:var(--sf-h,760px);overflow-y:auto;overflow-x:hidden;background:var(--surface-2);-webkit-overflow-scrolling:touch;scrollbar-width:thin;scrollbar-color:rgba(20,32,52,.28) transparent}
  .sf-scroll img.shot{width:100%;height:auto;display:block;border:0;border-radius:0;box-shadow:none}
  .sf-scroll::-webkit-scrollbar{width:11px}
  .sf-scroll::-webkit-scrollbar-thumb{background:rgba(20,32,52,.24);border-radius:8px;border:3px solid #fff;background-clip:padding-box}
  .sf-scroll::-webkit-scrollbar-thumb:hover{background:rgba(20,32,52,.4);background-clip:padding-box}
  .sf-scroll::-webkit-scrollbar-track{background:transparent}
  /* smaller windows inside the side-by-side step layout and the 2-up grids */
  .shot-grid .sf-scroll,.shot-step .sf-scroll{--sf-h:460px}
  @media(max-width:820px){.sf-scroll{--sf-h:62vh!important}}

  /* ---- recognition block (real internal award) ---- */
  .reco{display:grid;grid-template-columns:.8fr .8fr 1.15fr;gap:var(--s-4);align-items:center;border:1px solid var(--hairline);border-radius:var(--r-3);background:var(--surface);padding:32px;box-shadow:var(--shadow-1)}
  .reco .rphoto{margin:0}
  .reco .rimg{width:100%;height:auto;display:block;border:1px solid var(--line);border-radius:var(--r-2);background:var(--surface-2)}
  .reco .rphoto figcaption{font-family:'Geist Mono',monospace;text-transform:uppercase;letter-spacing:.08em;font-size:10px;color:var(--ink-faint);margin-top:9px;text-align:center}
  .reco .rbadge{font-family:'Geist Mono',monospace;text-transform:uppercase;letter-spacing:.12em;font-size:11px;color:var(--accent);background:var(--accent-soft);border:1px solid var(--accent);border-radius:var(--r-pill);padding:5px 12px;display:inline-block;margin-bottom:14px}
  .reco h3{font-size:clamp(20px,2.6vw,28px);margin-bottom:14px}
  .reco p{font-size:15.5px;color:var(--ink-soft);margin-bottom:12px}
  .reco .rq{position:relative;font-family:'Switzer',serif;font-style:normal;font-size:18px;color:var(--ink);line-height:1.45;padding-top:26px}
  .reco .rq::before{content:'\\201C';position:absolute;top:-6px;left:-2px;font-family:'Switzer',serif;font-size:48px;line-height:1;color:var(--green);opacity:.92}
  @media(max-width:820px){.reco{grid-template-columns:1fr 1fr}.reco .rtext{grid-column:1 / -1}}
  ...
  @media(max-width:820px){
    ...
    .cards,.cards.trio,.flow-compare,.decision,.visual-grid{grid-template-columns:1fr}
...
<style dangerouslySetInnerHTML={{ __html: `.stj{height:480vh;position:relative}
.stj .stick{position:sticky;top:0;height:100vh;padding:clamp(10px,1.6vh,18px);display:grid;place-items:center}
.stj .stage{position:relative;height:min(100%,760px);width:100%;border-radius:24px;overflow:hidden;
...
.stj .beat{grid-area:1/1;width:min(760px,calc(100% - clamp(40px,7vw,96px)));text-align:center;
  opacity:0;transform:translateY(16px);pointer-events:none;position:relative;z-index:3;
  transition:opacity .5s cubic-bezier(.22,1,.36,1),transform .5s cubic-bezier(.22,1,.36,1)}
.stj .beat.on{opacity:1;transform:none}
.stj .stepk{font-family:'Switzer',system-ui,sans-serif;font-weight:500;font-size:11px;
  letter-spacing:.16em;text-transform:uppercase;color:rgba(22,19,15,.55);margin-bottom:10px}
.stj .steph{font-size:clamp(16px,1.7vw,21px);color:rgba(22,19,15,.8);letter-spacing:-.015em;
  line-height:1.4;margin-bottom:clamp(20px,3.6vh,36px);text-wrap:balance}
.stj .big{font-size:clamp(28px,4.2vw,54px);line-height:1.14;letter-spacing:-.035em;color:#16130f}
.stj .big .a{color:var(--accent,#0083E7)}
.stj .pile{display:flex;flex-direction:column;gap:9px;align-items:center}
.stj .pg{display:flex;align-items:center;gap:10px;background:#fff;border:1px solid rgba(22,19,15,.11);
  border-radius:12px;padding:10px 16px;font-size:13.5px;color:rgba(22,19,15,.75);
  box-shadow:0 8px 20px -12px rgba(22,19,15,.18);min-width:min(360px,82vw);text-align:left;
  opacity:0;transform:translateY(10px);
  transition:opacity .45s cubic-bezier(.22,1,.36,1),transform .45s cubic-bezier(.22,1,.36,1)}
.stj .pg.on{opacity:1;transform:none}
.stj .pg .ic{font-size:15px;flex:0 0 auto}
.stj .pg b{font-weight:600;color:#16130f}
.stj .pile .still{margin-top:8px;font-family:'Geist Mono',ui-monospace,monospace;font-size:11.5px;
  letter-spacing:.06em;color:#b45309;opacity:0;transition:opacity .4s}
.stj .pile .still.on{opacity:1}
.stj .lc{display:inline-block;text-align:left;background:#fff;border:1px solid rgba(22,19,15,.09);
  border-radius:18px;padding:20px 22px;box-shadow:0 18px 44px -20px rgba(22,19,15,.24);width:min(440px,86vw)}
.stj .lc .ttl{display:flex;justify-content:space-between;align-items:center;font-size:15px;
  font-weight:650;color:#16130f;margin-bottom:12px}
.stj .lc .ttl span:last-child{font-size:11px;font-weight:400;color:rgba(22,19,15,.45)}
.stj .fr{display:flex;align-items:center;justify-content:space-between;gap:12px;
  border:1px solid rgba(22,19,15,.11);border-radius:11px;padding:8.5px 13px;
  font-size:12.5px;margin-top:7px;opacity:.35;transition:opacity .4s}
.stj .fr.on{opacity:1}
.stj .fr .k{color:rgba(22,19,15,.45)}
.stj .fr .v{color:#16130f;font-weight:600;white-space:nowrap}
.stj .sub{margin-top:12px;text-align:center;background:#eaf7ee;border:1px solid #74c08a;
  border-radius:11px;padding:10px 0;font-size:13px;color:#1d6b3c;font-weight:500;
  opacity:0;transform:translateY(8px);
  transition:opacity .45s cubic-bezier(.22,1,.36,1),transform .45s cubic-bezier(.22,1,.36,1)}
.stj .sub.on{opacity:1;transform:none}
.stj .num{font-size:clamp(54px,8vw,110px);line-height:1;letter-spacing:-.045em;color:#16130f;
  font-variant-numeric:tabular-nums}
.stj .num .a{color:var(--accent,#0083E7)}
.stj .cap{margin-top:14px;font-size:clamp(16px,1.8vw,22px);color:rgba(22,19,15,.75);letter-spacing:-.015em}
@media(prefers-reduced-motion:reduce){
  .stj{height:auto}
  .stj .stick{position:static;height:auto}
  .stj .stage{display:block;padding:44px 24px;height:auto}
  .stj .beat{opacity:1;transform:none;margin:0 auto 44px;grid-area:auto}
  .stj .pg,.stj .fr,.stj .sub,.stj .pile .still{opacity:1;transform:none}
}` }} />
